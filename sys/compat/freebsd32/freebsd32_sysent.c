...
struct sysent freebsd32_sysent[] = {
	...
	{ .sy_narg = AS(freebsd-1_lkmnosys_args), .sy_call = (sy_call_t *)freebsd-1_lkmnosys, .sy_auevent = AUE_NULL, .sy_flags = 0, .sy_thrcnt = SY_THR_ABSENT },	/* 210 = lkmnosys */
	{ .sy_narg = AS(freebsd-1_lkmnosys_args), .sy_call = (sy_call_t *)freebsd-1_lkmnosys, .sy_auevent = AUE_NULL, .sy_flags = 0, .sy_thrcnt = SY_THR_ABSENT },	/* 211 = lkmnosys */
	{ .sy_narg = AS(freebsd-1_lkmnosys_args), .sy_call = (sy_call_t *)freebsd-1_lkmnosys, .sy_auevent = AUE_NULL, .sy_flags = 0, .sy_thrcnt = SY_THR_ABSENT },	/* 212 = lkmnosys */
	{ .sy_narg = AS(freebsd-1_lkmnosys_args), .sy_call = (sy_call_t *)freebsd-1_lkmnosys, .sy_auevent = AUE_NULL, .sy_flags = 0, .sy_thrcnt = SY_THR_ABSENT },	/* 213 = lkmnosys */
	{ .sy_narg = AS(freebsd-1_lkmnosys_args), .sy_call = (sy_call_t *)freebsd-1_lkmnosys, .sy_auevent = AUE_NULL, .sy_flags = 0, .sy_thrcnt = SY_THR_ABSENT },	/* 214 = lkmnosys */
	{ .sy_narg = AS(freebsd-1_lkmnosys_args), .sy_call = (sy_call_t *)freebsd-1_lkmnosys, .sy_auevent = AUE_NULL, .sy_flags = 0, .sy_thrcnt = SY_THR_ABSENT },	/* 215 = lkmnosys */
	{ .sy_narg = AS(freebsd-1_lkmnosys_args), .sy_call = (sy_call_t *)freebsd-1_lkmnosys, .sy_auevent = AUE_NULL, .sy_flags = 0, .sy_thrcnt = SY_THR_ABSENT },	/* 216 = lkmnosys */
	{ .sy_narg = AS(freebsd-1_lkmnosys_args), .sy_call = (sy_call_t *)freebsd-1_lkmnosys, .sy_auevent = AUE_NULL, .sy_flags = 0, .sy_thrcnt = SY_THR_ABSENT },	/* 217 = lkmnosys */
	{ .sy_narg = AS(freebsd-1_lkmnosys_args), .sy_call = (sy_call_t *)freebsd-1_lkmnosys, .sy_auevent = AUE_NULL, .sy_flags = 0, .sy_thrcnt = SY_THR_ABSENT },	/* 218 = lkmnosys */
	{ .sy_narg = AS(freebsd-1_lkmnosys_args), .sy_call = (sy_call_t *)freebsd-1_lkmnosys, .sy_auevent = AUE_NULL, .sy_flags = 0, .sy_thrcnt = SY_THR_ABSENT },	/* 219 = lkmnosys */
