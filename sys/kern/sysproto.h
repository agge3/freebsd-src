...
struct __syscall_args {
	char number_l_[PADL_(int64_t)]; int64_t number; char number_r_[PADR_(int64_t)];
};
...
int	sys_syscall(struct thread *, struct syscall_args *);
void	sys_exit(struct thread *, struct exit_args *);
int	sys_fork(struct thread *, struct fork_args *);
ssize_t	sys_read(struct thread *, struct read_args *);
ssize_t	sys_write(struct thread *, struct write_args *);
...
void	sys_break(struct thread *, struct break_args *);
pid_t	sys_getpid(struct thread *, struct getpid_args *);
...
uid_t	sys_getuid(struct thread *, struct getuid_args *);
uid_t	sys_geteuid(struct thread *, struct geteuid_args *);
int	sys_ptrace(struct thread *, struct ptrace_args *);
ssize_t	sys_recvmsg(struct thread *, struct recvmsg_args *);
ssize_t	sys_sendmsg(struct thread *, struct sendmsg_args *);
ssize_t	sys_recvfrom(struct thread *, struct recvfrom_args *);
...
pid_t	sys_getppid(struct thread *, struct getppid_args *);
int	sys_dup(struct thread *, struct dup_args *);
gid_t	sys_getegid(struct thread *, struct getegid_args *);
int	sys_profil(struct thread *, struct profil_args *);
int	sys_ktrace(struct thread *, struct ktrace_args *);
gid_t	sys_getgid(struct thread *, struct getgid_args *);
...
ssize_t	sys_readlink(struct thread *, struct readlink_args *);
int	sys_execve(struct thread *, struct execve_args *);
mode_t	sys_umask(struct thread *, struct umask_args *);
...
ssize_t	sys_readv(struct thread *, struct readv_args *);
ssize_t	sys_writev(struct thread *, struct writev_args *);
...
ssize_t	sys_sendto(struct thread *, struct sendto_args *);
...
int	sys___syscall(struct thread *, struct __syscall_args *);
...
ssize_t	sys_msgrcv(struct thread *, struct msgrcv_args *);
void	sys_shmat(struct thread *, struct shmat_args *);
...
ssize_t	sys_preadv(struct thread *, struct preadv_args *);
ssize_t	sys_pwritev(struct thread *, struct pwritev_args *);
...
ssize_t	sys_aio_return(struct thread *, struct aio_return_args *);
...
ssize_t	sys_extattr_set_file(struct thread *, struct extattr_set_file_args *);
ssize_t	sys_extattr_get_file(struct thread *, struct extattr_get_file_args *);
int	sys_extattr_delete_file(struct thread *, struct extattr_delete_file_args *);
ssize_t	sys_aio_waitcomplete(struct thread *, struct aio_waitcomplete_args *);
...
ssize_t	sys_extattr_set_fd(struct thread *, struct extattr_set_fd_args *);
ssize_t	sys_extattr_get_fd(struct thread *, struct extattr_get_fd_args *);
...
ssize_t	sys_extattr_set_link(struct thread *, struct extattr_set_link_args *);
ssize_t	sys_extattr_get_link(struct thread *, struct extattr_get_link_args *);
...
void	sys_thr_exit(struct thread *, struct thr_exit_args *);
...
ssize_t	sys_extattr_list_fd(struct thread *, struct extattr_list_fd_args *);
ssize_t	sys_extattr_list_file(struct thread *, struct extattr_list_file_args *);
ssize_t	sys_extattr_list_link(struct thread *, struct extattr_list_link_args *);
...
void	sys_abort2(struct thread *, struct abort2_args *);
...
ssize_t	sys_pread(struct thread *, struct pread_args *);
ssize_t	sys_pwrite(struct thread *, struct pwrite_args *);
void	sys_mmap(struct thread *, struct mmap_args *);
off_t	sys_lseek(struct thread *, struct lseek_args *);
...
ssize_t	sys_readlinkat(struct thread *, struct readlinkat_args *);
...
ssize_t	sys_cap_ioctls_get(struct thread *, struct cap_ioctls_get_args *);
...
ssize_t	sys_getdirentries(struct thread *, struct getdirentries_args *);
...
ssize_t	sys_copy_file_range(struct thread *, struct copy_file_range_args *);
...
void	ommap(struct thread *, struct ommap_args *);
...
long	ogethostid(struct thread *, struct ogethostid_args *);
...
ssize_t	freebsd6_pread(struct thread *, struct freebsd6_pread_args *);
ssize_t	freebsd6_pwrite(struct thread *, struct freebsd6_pwrite_args *);
void	freebsd6_mmap(struct thread *, struct freebsd6_mmap_args *);
off_t	freebsd6_lseek(struct thread *, struct freebsd6_lseek_args *);
